...
import com.manager.mymanager.activities.MembersActivity
...
//            if(FirestoreClass().removalMemberPermission(mBoardDetails)){
//                holder.itemView.iv_delete_member.visibility=View.VISIBLE
//            }else{
//                holder.itemView.iv_delete_member.visibility=View.GONE
//            }
//
//            holder.itemView.iv_delete_member.setOnClickListener {
//                FirestoreClass().deleteMemberFromBoard(context as MembersActivity,mBoardDetails,model.id)
//            }
