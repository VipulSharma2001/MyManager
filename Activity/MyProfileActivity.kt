...
class MyProfileActivity : BaseActivity() {
    ...
    private fun updateUserProfileData(){
        ...
        if(et_mobile.text.toString().isEmpty()){
            userHashMap[Constants.MOBILE]=0.toLong()
        }else{
    ...
    private fun uploadUserImage(){
        showProgressDialog(resources.getString(R.string.please_wait))
        if(mSelectedImageFileUri!=null){
            val sRef: StorageReference = FirebaseStorage.getInstance().reference.child("USER_IMAGE"+FirebaseAuth.getInstance().currentUser!!.uid+"."+Constants.getFileExtension(this,mSelectedImageFileUri))
